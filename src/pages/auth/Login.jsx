      ...
      <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-[#0a2540] via-[#0b2a4a] to-[#081f36] text-white px-20 py-20 flex-col justify-between">
        ...
        <div>
          ...
          <h1 className="text-5xl font-bold leading-tight mb-6">
            ...
            Auto Finance Journey

          </h1>

          <p className="text-gray-300 max-w-xl">

            Digitize, verify, and process loan
        ...
        <div className="flex gap-16">
          ...
          <div>
            ...
            <h3 className="text-[#1cc5b7] text-2xl">
              500+
            </h3>
        ...
        <div className="bg-white w-full max-w-md p-10 rounded-2xl shadow-xl">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3 bg-[#0b2a4a] text-white rounded-lg font-medium hover:bg-[#081f36] transition disabled:opacity-70"
            >
